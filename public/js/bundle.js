...
var favourite = document.querySelectorAll('#heart');
var favSection = document.querySelector('.favourite-section');
...
if (favourite) {
  favourite.forEach(function (el) {
    el.addEventListener('click', function () {
      var localDataString = localStorage.getItem('fav');
      var localData = JSON.parse(localDataString);
      var image_url, food_name, recipe_id;
      image_url = el.parentElement.parentElement.getElementsByTagName('img')[0].getAttribute('src');
      food_name = el.parentElement.getElementsByTagName('p')[0].innerHTML;
      recipe_id = el.parentElement.getElementsByTagName('a')[0].getAttribute('href');
      var obj = {
        image_url: image_url,
        food_name: food_name,
        recipe_id: recipe_id
