...
if (favourite) {
  favourite.forEach(function (el) {
    el.addEventListener('click', function () {
      var localData = JSON.parse(localStorage.getItem('fav'));
      var image_url, food_name;
      ...
      if (localData !== null && localData != undefined) {
        ...
        var _jsonString = JSON.stringify({
          image_url: image_url,
          food_name: food_name
        });

        localStorage.setItem('fav', "{\"favs\": [".concat(_jsonString, "]}"));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41377" + '/');
